      ...
      <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl bg-deepPurple px-5 py-7 leading-7 text-white">
          ...
          <p className="my-3 font-medium">
            Very impressive video editing tool I have ever seen. It has so many
            awesome features to edit a video like pro. I have enjoyed a lot
            while making my youtube channel video. Really impressive video
            editing tool for me.
          </p>
          <div>
